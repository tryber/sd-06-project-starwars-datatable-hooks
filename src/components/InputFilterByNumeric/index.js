  ...
  return (
    <>
      <select
        ...
        onChange={ (evento) => setLocal3Filters({ ...local3Filters, column: evento.target.value }) }
      >
      ...
      <select
        ...
        onChange={ (evento) => setLocal3Filters({ ...local3Filters, comparison: evento.target.value }) }
      >
      ...
      <input
        ...
        min={ 0.85 }
        step={ 0.01 }
        onChange={ (evento) => setLocal3Filters({ ...local3Filters, value: evento.target.value }) }
      />
      <button
        type="button"
        data-testid="value-filter"
      ...
      >
        {console.log('filteredBy', filterByNumbers)}
        Filtrar
      </button>
    </>
  );
